...
def default_argparser(arguments=sys.argv[1:], docstring=None, override=None):
    ...
    p.add_argument('-n', '--nick', default=__title__,
                   help='specify nickname to use')
    ...
    p.add_argument('-c', '--channels', default='',
                   help='comma-separated channels to connect to when joining')
    p.add_argument('--user-name', dest='username', default=__title__,
                   help='specify different name to use')
    p.add_argument('--real-name', dest='realname', default=__title__,
                   help='specify different realname to use')
    p.add_argument('-v', '--version',
                   help='show version of this program', action='store_true')
